            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edit Whatsapp
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-actions right">
                            ...
                            <button type="submit" type="submit" name="submit" id="button"

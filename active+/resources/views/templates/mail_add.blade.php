            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add Mail Template
                                ...
                                <div class="row container">
                                    <div class="col-lg-9 bordered border-right">
                                        ...
                                        <div class="row container">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="userinput4"><b> From Email :</b></label>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <fieldset class="floating-label-form-group">
                                                        <textarea name="subject" rows="1" class=" form-control" placeholder="Enter Subject"></textarea>
                                                        <span id="Alert" class="text-center"
                                                            style="text-align: center;"></span>
                                                    </fieldset>
                                                </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label for="userinput4"><b>Compose email:</b></label>
                                                    <fieldset class="floating-label-form-group">
                                                        <textarea rows="9" name="comment" id="" class="name form-control" placeholder="Dear,"></textarea>
                                                    </fieldset>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">

         ...
         <div class="col-xl-12 col-lg-12 col-12">
            <div class="card">
               <div class="card-header">
                  <h4 class="card-title">Quotation Add
   ...
   <x-slot name="page_level_scripts">
      <script type="text/javascript">
         $(document).on('change','.Product',function(){
            ...
            $.post("quotation_new_rate",{"_token":"{{ csrf_token() }}","Product":Product},function(data){
               CurTr.find(".Cost").val(data);
               Cost=data;
               $.post("quotation_new_gst",{"_token":"{{ csrf_token() }}","Product":Product},function(data){
         ...
         $(document).on('change','.Service',function(){
            ...
            $.post("quotation_new_rate_service",{"_token":"{{ csrf_token() }}","Service":Service},function(data){
               CurTr.find(".Cost").val(data);
               Cost=data;
               $.post("quotation_new_gst_service",{"_token":"{{ csrf_token() }}","Service":Service},function(data){
                  CurTr.find(".GST").val(data);
                  GST=data;
                  $("tr .select2").select2();
                  var TotalProduct=(Cost*Quantity);
         ...
         $(document).ready(function(){
            ...
            ValidateTax(GSTTypeIn);
            $.post("quotation_new_product",{"_token": "{{ csrf_token() }}","GSTTypeIn":GSTTypeIn,"input_type":input_type},function(data){

<x-app-layout>
         ...
         <div class="col-xl-12 col-lg-12">
            <div class="card">
               <div class="card-header">
                  <h4 class="card-title">Quotations
   ...
   @php
   $DeleteTableName="quotations";
   $DeleteColumnName="quotation_id";
   @endphp
   @include('delete')
      ...
      <script type="text/javascript">
         $(function () {
            var table = $('.product').DataTable({
               ...
               order: [[ 0, "desc" ]],
               serverSide: true,
               ajax: "{{ route('quotations') }}",
               columns: [
               {data: 'quotation_id', name: 'a.quotation_id'},

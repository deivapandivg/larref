                                ...
                                <div class="row container">
                                    <div class="col-lg-9 bordered border-right">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="Template Name" required
                                                        ...
                                                        placeholder="Template Name" value="{{ $mail->template_name }}">
                                        ...
                                        <div class="row container">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="userinput4"><b>Email :</b></label>
                                                    <fieldset class="floating-label-form-group">
                                                        <input type="Mail" name="email" class="form-control"
                                                            placeholder="E-Mail" value="{{ $mail->email }}">
                                                        <span id="Alert" class="text-center"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="userinput4"><b>Subject :</b></label>
                                                    <fieldset class="floating-label-form-group">
                                                        <textarea name="subject" rows="1" class=" form-control" placeholder="Enter Subject">{{ $mail->subject }}</textarea>
                                                        <span id="Alert" class="text-center"
                                                            style="text-align: center;"></span>
                                                    </fieldset>
                                                </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label for="userinput4"><b>Comments :</b></label>
                                                    <fieldset class="floating-label-form-group">
                                                        <textarea rows="9" name="comments" id="" class="name form-control" placeholder="Dear,">{{ $mail->comments }}</textarea>
                                                    </fieldset>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">

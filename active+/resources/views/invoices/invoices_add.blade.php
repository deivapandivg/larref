         ...
         <div class="col-xl-12 col-lg-12 col-12">
            <div class="card">
               <div class="card-header">
                  <h4 class="card-title">Invoice Add
   ...
   <x-slot name="page_level_scripts">
      <script type="text/javascript">
         $(document).on('change','.Product',function(){
            ...
            $.post("invoice_new_rate",{"_token":"{{ csrf_token() }}","Product":Product},function(data){
               CurTr.find(".Cost").val(data);
               Cost=data;
               $.post("invoice_new_gst",{"_token":"{{ csrf_token() }}","Product":Product},function(data){
         ...
         $(document).on('change','.Service',function(){
            ...
            $.post("invoice_new_rate_service",{"_token":"{{ csrf_token() }}","Service":Service},function(data){
               CurTr.find(".Cost").val(data);
               Cost=data;
               $.post("invoice_new_gst_service",{"_token":"{{ csrf_token() }}","Service":Service},function(data){
                  CurTr.find(".GST").val(data);
                  GST=data;
                  $("tr .select2").select2();
                  var TotalProduct=(Cost*Quantity);
         ...
         $(document).ready(function(){
            ...
            ValidateTax(GSTTypeIn);
            $.post("invoice_new_product",{"_token": "{{ csrf_token() }}","GSTTypeIn":GSTTypeIn,"input_type":input_type},function(data){

<x-app-layout>
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Mail Template
                        ...
                        <div class="heading-elements">
                            <a href="{{ route('mail_add') }}">
                                <button class="btn btn-primary">
                                    <i class="fa fa-plus"></i> Mail Template
                                </button>
                            </a>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered mail" style="width:100%;">
                                        <thead>
                                            <tr>
                                                <th>Id</th>
                                                <th>&nbsp;&nbsp;&nbsp;Action&nbsp;&nbsp;&nbsp;</th>
    ...
    @php
        $DeleteTableName = 'com_template_mail';

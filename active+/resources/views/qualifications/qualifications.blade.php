<x-app-layout>
         ...
         <div class="col-xl-12 col-lg-12">
            <div class="card">
               <div class="card-header">
                  <h4 class="card-title">Qualifications
               ...
               <div class="card-content">
                  <div class="card-body">
                     <div class="table-responsive">
                        <table class="table table-striped table-bordered qualification" style="width:100%;">
                           <thead>
                              <tr>
         ...
         <div class="modal-content">
            <section class="contact-form">
               <div class="modal-header bg-primary white">
                  <h5 class="modal-title white">Qualification</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                     <span aria-hidden="true">&times;</span>
                  </button>
               </div>
               <form method="post" action="{{ route('qualifications_submit') }}">
                  @csrf
                        ...
                        <div class="col-lg-12">
                           <div class="form-group">
                              <fieldset class="form-group floating-label-form-group"><b>Qualification Name <sup class="text-danger" style="font-size: 13px;">*</sup> :</b>
                                 <input type="text" id="" required name="qualification_name" class="name form-control" placeholder="Qualification Name">
                              </fieldset>
                           </div>
                        </div>
                     </div> 
   ...
   <div class="modal fade" id="edit_modal_qualifications"  role="dialog" aria-labelledby="edit_modal_qualifications" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered  modal-md" role="document">
         <div class="modal-content">
            <section class="contact-form">
               <div class="modal-header bg-primary white">
   ...
   @php
   $DeleteTableName="qualifications";
   $DeleteColumnName="qualification_id";
   @endphp
   @include('delete')
      ...
      <script type="text/javascript">
         $(function () {
            var table = $('.qualification').DataTable({
               ...
               order: [[ 0, "desc" ]],
               serverSide: true,
               ajax: "{{ route('qualifications') }}",
               columns: [
               {data: 'qualification_id', name: 'a.qualification_id'},
               {data: 'action', name: 'a.action', orderable: false, searchable: false},
               {data: 'qualification_name', name: 'a.qualification_name'},
         ...
         $(document).on('click', '.edit_model_btn', function(){
            var qualification_id=$(this).closest("tr").find("td:eq(0)").text();
            $.ajax({
               url: 'qualifications_edit/'+qualification_id,
               type: "GET",
               data : {"_token":"{{ csrf_token() }}"},
               success:function(data) {
                  $("#menu_group_edit_modal_form").html(data);
                  $("#edit_modal_qualifications").modal('show');
               }
            });
         });

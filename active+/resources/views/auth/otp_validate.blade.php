            ...
            <div class="col-lg-4 col-md-6 col-10 box-shadow-2 p-0">
                <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-body">
                            <form method="POST" class="form-horizontal" action="{{route('otp_check')}}" novalidate>
                                @csrf
                                <fieldset class="form-group position-relative has-icon-left">
                                    <input type="text" class="form-control round" id="otp" placeholder="Enter OTP Number" name="otp" required>

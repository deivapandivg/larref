<x-app-layout>
   <section id="tabs-with-icons">
         ...
         <div class="col-xl-12 col-lg-12">
            <div class="card">
               <div class="card-header">
                  <h4 class="card-title">Sms Template
                  ...
                  <div class="heading-elements">
                       <a href="{{ route('sms_add') }}">
                           <button class="btn btn-primary">
                              <i class="fa fa-plus"></i> Sms Template 
                           </button>
                       </a>
                  </div>
                  ...
                  <div class="card-body">
                     <div class="table-responsive">
                        <table class="table table-striped table-bordered sms" style="width:100%;">
                           <thead>
                              <tr>
                                 <th>Id</th>
                                 <th>&nbsp;&nbsp;&nbsp;Action&nbsp;&nbsp;&nbsp;</th>
    ...
    @php
   $DeleteTableName="com_template_sms";

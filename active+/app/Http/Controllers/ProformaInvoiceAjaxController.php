...
class ProformaInvoiceAjaxController extends Controller
{
	public function __construct()
   {
    ...
    public function proforma_invoice_new_product(Request $request){
    ...
    public function proforma_invoice_new_gst(Request $request){
    ...
    public function proforma_invoice_new_rate(Request $request){
    ...
    public function proforma_invoice_new_gst_service(Request $request){
    ...
    public function proforma_invoice_new_rate_service(Request $request){

...
class InvoiceAjaxController extends Controller
{
    ...
    public function invoice_new_product(Request $request){
    ...
    public function invoice_new_gst(Request $request){
    ...
    public function invoice_new_rate(Request $request){
    ...
    public function invoice_new_gst_service(Request $request){
    ...
    public function invoice_new_rate_service(Request $request){

         ...
         <div class="col-xl-12 col-lg-12 col-12">
            <div class="card">
               <div class="card-header">
                  <h4 class="card-title">Service Add
                           ...
                           <div class="col-lg-6">
                              <div class="form-group">
                                 <fieldset class="form-group floating-label-form-group"><b>Service Code <sup class="text-danger" style="font-size: 13px;">*</sup> :</b>
                                    <input type="text" id="" required name="service_code" class="name form-control" placeholder="Service Code">
                                 </fieldset>
                              </div>
                           </div>
                           <div class="col-lg-6">
                              <div class="form-group">
                                 <fieldset class="form-group floating-label-form-group"><b>Service Category Name <sup class="text-danger" style="font-size: 13px;">*</sup> :</b>
                                    <select class="form-control border-primary select2 form-select" name="service_category_id" data-placeholder="Choose one" style="width:100%;">
                                       ...
                                       <option value="{{  $service_category_list->service_category_id }}">{{ $service_category_list->service_category_name }}</option>
                                       @endforeach
                                    </select>
                                 </fieldset>
                              </div>
                           ...
                           <div class="col-lg-6">
                              <div class="form-group">
                                 <fieldset class="form-group floating-label-form-group"><b>Service Name <sup class="text-danger" style="font-size: 13px;">*</sup> :</b>
                                    <input type="text" id="" required name="service_name" class="name form-control" placeholder="Service Name">
                                 </fieldset>
                              </div>
                           </div>
                           <div class="col-lg-6">
                              <div class="form-group">
                                 <fieldset class="form-group floating-label-form-group"><b>Service Amount <sup class="text-danger" style="font-size: 13px;">*</sup> :</b>
                                    <input type="text" id="" required name="service_amount" class="name form-control" placeholder="Service Amount">
                                 </fieldset>
                              </div>
                           </div>
                           <div class="col-lg-6">
                           ...
                           <div class="col-lg-12">
                              <div class="form-group">
                                 <fieldset class="form-group floating-label-form-group"><b>Service Description <sup class="text-danger" style="font-size: 13px;">*</sup> :</b>
                                    <textarea id="" required name="service_description" class="name form-control" placeholder="Service Description"></textarea>
                                 </fieldset>
                              </div>
                           </div>
                        </div>
